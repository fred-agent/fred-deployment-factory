...
```text
gcp-c1/helm/legal/gcu.fr.md
gcp-c1/helm/legal/gcu.md
gcp-c1/helm/legal/gdpr.fr.md
gcp-c1/helm/legal/gdpr.md
```
...
Add to `gcp-c1/helm/fredlab-secrets.values.yaml`:
...
If Helm reports `path "./gcp-c1/helm" not found`, return to the repository root:
